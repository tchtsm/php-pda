...
<form class="layui-form" action="{{ isset($data) ? route('b_book_edit') : route('b_book_add')}}">
	...
	<div class="layui-form-item layui-form-text">
		...
		<div class="layui-input-block">
			<textarea class="layui-textarea" name="introduce" lay-verify="required" placeholder="请输入简介">{{ isset($data) ? $data->introduce : '' }}</textarea>
		</div>
	</div>
	<div class="layui-form-item layui-form-text">
		<label class="layui-form-label">目录</label>
		<div class="layui-input-block">
			<textarea class="layui-textarea" name="menu" lay-verify="required" placeholder="请输入目录">{{ isset($data) ? $data->menu : '' }}</textarea>
		</div>
	</div>
	<div class="layui-form-item">
